...
hostname = 'redis-18365.c241.us-east-1-4.ec2.redns.redis-cloud.com'
port = 18365
password = 'joIu3QcLCroc1IxFdM9TsVoXCMHFwimO'
...
@app.route('/enroll_terminate')
def enroll_terminate():
    return render_template('enroll_terminate.html')
